...
Shader "Custom/CorrectWaterShader"
{
	Properties
	{
		_Color("Color", Color) = (1, 1, 1, 1)
		// this was not deleted in the 'complete' code.
		// _EdgeColor("Edge Color", Color) = (1, 1, 1, 1)
		_DepthFactor("Depth Factor", float) = 1.0

		// Using my settings, this seems to be best set to 100 instead of the 1.0 in the tutorial.
		// Perhaps I'm configuring this wrong, though.
		_WaveSpeed("Wave Speed", float) = 100
		_WaveAmp("Wave Amp", float) = 0.2
		// Used the ramp texture from the RampWaterShader.
